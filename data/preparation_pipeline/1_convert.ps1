...
# ATTENTION: replace .\cifar\ with your respective data directory!
$letterArray = Get-ChildItem -Path .\cifar\ -Recurse -Include *.png | Where { ! $_.PSIsContainer } | Select FullName
